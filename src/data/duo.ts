...
/**
 * Copy and figures for the Duo act (sections 12–18) and the closing
 * differentiators (19–20).
 *
 * The Duo evidence is materially weaker than the Pro evidence, and the page
...
export const DUO_SPECS: readonly DuoSpec[] = [
...
/**
 * Two only. The spec is explicit that presenting four or five Duo colours
 * would overstate evidence that barely supports two.
 */
export const DUO_FINISHES: readonly DuoFinish[] = [
  {
    id: 'silver',
    name: 'Silver',
...
export const PRO_VS_DUO: readonly CompareRow[] = [
...
export const CONFIDENCE_MAP: readonly ConfidenceBar[] = [
  ...
  { claim: 'The name “iPhone Duo”', value: 0.5, level: 'developing', note: 'Duo and Fold are both in circulation.' },
  { claim: 'Duo colour lineup', value: 0.4, level: 'uncertain', note: 'The weakest claim on this page. Two shades, thinly sourced.' },
];
...
export const SOURCES: readonly SourceLink[] = [
  ...
  { label: 'iPhone 18 Pro colour guide', href: 'https://www.macrumors.com/guide/iphone-18-pro-ultra-colors/', kind: 'MacRumors' },
