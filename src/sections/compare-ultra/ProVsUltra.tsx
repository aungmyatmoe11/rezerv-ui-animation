...
import { PRO_VS_ULTRA, ULTRA_TRADEOFFS } from '@/data/ultra';
import styles from './ProVsUltra.module.scss';
  ...
  return (
    <Section id="compare-ultra">
      ...
      <div className={styles.tableWrap}>
        <CompareTable
          caption="iPhone 18 Pro compared with iPhone Ultra"
          columns={['iPhone 18 Pro', 'iPhone Ultra']}
          rows={PRO_VS_ULTRA}
        />
      </div>
    </Section>
